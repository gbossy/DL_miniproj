...
#No normalization since it is in [0, 1]^2 this is just a traslation and a sqrt(3) resizing in both directions
...
#Initialize a second test model using linear layers and relu activation functions except for the last layer that's softmax activation function and thus has 2 outputs
linear1 = Linear(2, 25, True)
linear2 = Linear(25,25,True)
linear3 = Linear(25,25,True)
